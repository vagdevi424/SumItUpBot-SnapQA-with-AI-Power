...
def analyze_sentiment(text):
    ...
    return result[0]  # Return the sentiment result (label and score)
...
async def delete_document():
    ...
    uploaded_files.clear()  # Clear the stored files and data
    faiss_index.reset()  # Reset the FAISS index
    return {"message": "Document deleted successfully. You can upload a new document."}
